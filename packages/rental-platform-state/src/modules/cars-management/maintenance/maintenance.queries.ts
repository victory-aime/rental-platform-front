...
const getMaintenanceListQueries = (args: TYPES.QUERIES.QueryPayload<{filters:TYPES.MODELS.CARS.MAINTENANCE.FilterMaintenanceDto}, any>) => {
...
const createMaintenanceMutation = (
  ...
  return TYPES.QUERIES.useCustomMutation<TYPES.MODELS.CARS.MAINTENANCE.CreateMaintenanceDto, any, AxiosError>({
...
const updateMaintenanceMutation = (
  ...
  return TYPES.QUERIES.useCustomMutation<TYPES.MODELS.CARS.MAINTENANCE.UpdateMaintenanceDto, any, AxiosError>({
...
const closeMaintenanceMutation = (
  args: TYPES.QUERIES.MutationPayload<{requestId: string}>
) => {
...
export {getMaintenanceListQueries, closeMaintenanceMutation,createMaintenanceMutation,updateMaintenanceMutation }
